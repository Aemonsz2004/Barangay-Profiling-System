...
<aside id="default-sidebar"
			className={`sticky top-0 left-0 z-30 w-64 aria-label="Sidebar" rounded-xl h-[96.5%] px-3 py-4  bg-[--color-lightest]  border- border-blue-gray-100 shadow-sm  ${className}`}>
		...
		<div className=' '>
			...
			ADMIN
				...
				<li>
					<a href="#" className="flex  items-center p-3 rounded-lg   hover:text-white hover:bg-gray-900 group">
				...
				<li>
					<a href="#" className="flex items-center p-3 text-gray-900 rounded-lg hover:text-white hover:bg-gray-700 group">
					...
					<span className=" flex-1 ms-3 whitespace-nowrap">Residents</span>
					
					</a>
				</li>
				<li>
					<a href="#" className="flex items-center  p-3 text-gray-900 rounded-lg hover:bg-gray-800 hover:text-white group">
				...
				<li>
					...
					<span className=" flex-1 ms-3 whitespace-nowrap">Economy</span>
					</a>
				</li>
				<li>
					<a href="#" className="flex items-center  p-3 text-gray-900 rounded-lg hover:bg-gray-800 hover:text-white group">
